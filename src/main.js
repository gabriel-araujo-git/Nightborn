...
let _APP = null;
let music = null; // variável global para o som

// 🎶 Música de fundo
function startMusic() {
  // Caminho relativo ao index.html
  music = new Audio('src/audio.mpeg'); 
  music.loop = true;         // Repetir indefinidamente
  music.volume = 0.4;        // Volume moderado
  music.play().catch(err => {
    console.warn('Música bloqueada até interação do usuário:', err);
  });
}

// ⏯️ Inicia após o primeiro clique do jogador
